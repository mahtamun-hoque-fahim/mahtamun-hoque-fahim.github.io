...
!(function () {
      ...
      var r = g(e.ownerDocument),
        ...
        n =
          ...
          (function (e) {
            ...
            return (
              x[f(x, o["no-preference"]) ? o["no-preference"] : "light"] +
              z("light", o.light) +
              z("dark", o.dark)
            );
          })(o["data-color-scheme"]);
    ...
    T = function (o, r) {
      if (null != o && null != r)
        if (
          ...
          var a = h("span");
          A(a.attachShadow({ mode: "closed" }), o, function () {
            r(a);
          });
        } else {
          var n = h("iframe", {
  ...
  o.protocol + "//" + o.host + o.pathname === i
    ? A(e.body, b(window.name || o.hash.replace(/^#/, "")), function () {})
    : (function (o) {
        if (
